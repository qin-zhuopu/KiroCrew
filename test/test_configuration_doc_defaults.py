...
def test_the_json_examples_agree_with_the_dataclasses(doc_text: str) -> None:
    ...
    assert examined > 30, f"only {examined} JSON example values checked; block shape likely changed"
    assert not wrong, "\n".join(wrong)
