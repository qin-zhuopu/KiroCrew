...
- **Nesting**: a subagent can spawn its own subagents. Nested children get their own `batch_id`, so they are not counted against the parent wave's completion total
